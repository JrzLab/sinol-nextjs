        ...
        >
          <CardHeader className="flex flex-row items-center justify-start pb-2">
            <Avatar className="mr-2">
              <AvatarImage
                src={`${process.env.NEXT_PUBLIC_WS_URL?.includes("localhost") ? process.env.NEXT_PUBLIC_WS_URL.replace("3001", "3002") : process.env.NEXT_PUBLIC_WS_URL?.replace("10073", "10059")}${student.imageUrl}`}
                alt="@shadcn"
              />
